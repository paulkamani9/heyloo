...
export function Header() {
  return (
    <header className="flex h-16 items-center justify-between gap-4 border-b px-4 bg-purple-400">
      <Link href="/" className="flex items-center gap-x-4">
        ...
        <span className="font-semibold text-2xl tracking-widest">heyloo</span>
      </Link>
